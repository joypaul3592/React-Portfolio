...
const Home = () => {
    return (
        <div className='pb-28 md:pb-0 md:h-screen  md:flex items-center md:px-10 px-8 md:pr-36'>
            <div data-aos="fade-right" className=' md:w-[45%] w-full h-80 rounded-t-full py-5 md:py-0 mt-5 md:mt-0 rounded-l-full border border-gray-300 mr-12'>
                <img className='lg:mt-[-100px]' src={heroImg} alt="Hero Image" />
            </div>
            <div data-aos="zoom-in" className='md:w-[45%] w-full py-5 md:py-0'>
                ...
                <a href="https://drive.google.com/file/d/1f74gBigUR-CoSnLVL022fSeCqNZHwM7L/view?usp=sharing" target="_blank">
                    <button className='py-1 px-5 flex btn hover:bg-orange-500 hover:border-orange-500 hover:text-white border transition border-black font-mono rounded-2xl mt-5'>Download Resume <BsArrowDownCircle className='animate-bounce arrow text-orange-500  ml-3 mt-[6px]' /></button>
                </a>
            </div>
